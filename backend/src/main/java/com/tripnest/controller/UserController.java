...
public class UserController {
    ...
    // GET /api/users/me/travel-history
    @GetMapping("/travel-history")
    public ResponseEntity<List<com.tripnest.dto.TripResponse>> getTravelHistory(
            @AuthenticationPrincipal CustomUserPrincipal principal
    ) {
        return ResponseEntity.ok(userService.getTravelHistory(principal.getId()));
    }
